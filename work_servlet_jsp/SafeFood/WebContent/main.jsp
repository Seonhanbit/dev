	...
	<div class="container-fluid">
        ...
        <section class="container" style="padding: 50px 0;">
                            ...
                            <div class="col-lg-4 col-md-6 isotope-item app-development"
                                ...
                                <div class="image-box hc-shadow-2 text-center mb-20">
                                    <div class="overlay-container">
                                        <a href="food.do?action=detail&code=${food.code }"><img width="200"
            ...
            <c:if test="${not empty param.key}">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="image-container">
                                <a href="food.do?action=detail&code=${food.code }"> <img alt="'+_arrName[i]+'" src="${food.img }" width="200" class="card-img"> <span
                ...
                <table>
                	<caption>[섭취가능한 식품의 조합 리스트]</caption>
	                <c:forEach items="${total_list }" var="i" end="4">
	                    <tr>
	                    	<td>${i.material}</td>
	                    	<td>${i.calory}</td>
	                   	</tr>
        ...
        <div class="footer-main bg-dark py-5 small">
            <div class="container-fluid" style="margin: 20px;">
                ...
                <i class="glyphicon glyphicon-envelope">&nbsp</i><span>admin@ssafy.com</span>
                <div style="float: right">${visited }</div>
                <br>
            </div>
        </div>
    </div>
