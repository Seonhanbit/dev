		...
		<table id="content" style="width: 90%; margin: 0 auto">
			...
			<c:forEach var="product" items="${foodlist }">
				<tr style='margin-left: 200px'>
					<td><a href='main.do?action=pdetail&code=${product.code	 }'><img width='180px' src="${product.image}" class='btn btn-gray-transparent btn-animated btn-sm'></a>
							<a href='main.do?action=pdetail&code=${product.code	 }'> 상품 정보로 이동 </a><i class='pl-10 fa fa-arrow-right'></i>
						...
						<button class='btn btn-sm btn-info' type='button'> <img width='20px' src='./img/사람.png'>찜</button>
					</td>
				</tr>
