...
<body>
	...
	<section class="container" style="padding: 50px 0;">
		<c:forEach items="${myallergy }" var="food">
			<div class="row">
				<div class="col-md-4">
					<div class="image-container">
						<a href="#"> <img alt="'+_arrName[i]+'" src="${food.img }"
							width="200" class="card-img"> <span class="desc"> <strong>${food.name}<br />${food.maker}
							</strong>
						</span></a>
					</div>
				</div>
				<div class="col-md-8">
					<div class="body">
						<h3 class="title">
							<a href="./nutrition.html">${food.name}</a>
						</h3>
