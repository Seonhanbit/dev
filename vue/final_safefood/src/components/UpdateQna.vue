...
<tr>
<th>내용</th>
<td><input data-msg="내용" type="text" name="content"  id="content" size="20" v-model="qna.content" style="width:100%"/></td>
</tr>
<tr>
<th>작성자 닉네임</th>
<td><input data-msg="작성자 닉네임" type="text" name="id"  id="id" size="30" v-model="qna.id" style="width:100%"/></td>
</tr>
