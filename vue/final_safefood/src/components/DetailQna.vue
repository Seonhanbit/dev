<template>
  <div>
    ...
    <table class="table_width">
      ...
      <tr>
        <th>내용</th><td class="content_size" v-html="qna.content"></td>
      </tr>
      <tr>
      ...
      <tr >
        ...
        <td>
          <input type="text" style="width:554px" v-model="content">
          <input type="button" class="blue" value="댓글달기" @click="add_comment()">
        </td>

      </tr>
      <tr v-for="com in comment" class="nicecolor" :key="com.num">
        <th v-html="com.id"></th>
        <th><td v-html="com.content" style="width:1000px"></td><td><input type="button" @click="del_comment(com.num)" class="blue" value="삭제하기"></td></th>
      </tr>
    </table>
    </center>
  </div>
...
export default {
  ...
  data() {
    return {
      ...
      id:'',
      qnanum:'',
      nowid:localStorage.getItem("saveid")
    };
  },
  filters: {
    salarydecimal(value) {
