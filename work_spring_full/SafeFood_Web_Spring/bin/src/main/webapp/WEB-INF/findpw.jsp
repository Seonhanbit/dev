	...
	<nav class="navbar navbar-inverse">
		<div class="container-fluid">
			...
			<c:if test="${islogin eq 'isLogin'}">
				<div id="navbar" class="navbar-collapse collapse">
					<ul class="nav navbar-nav navbar-right">
						<li><a href="memInfo"><img width="20px"
								src="./img/사람.png">회원정보수정</a></li>
						<li id=logout><a href="Logout"><img
				...
				<div class="panel panel-default">
					<div class="panel-body">
						...
						<div class="col-sm-10">
							...
							<form class="form-horizontal" action="searchpw"
		...
		<form action="Login" id="popForm" method="post">
			<div>
				<label for="email" style="color: white;">ID</label> <br /> <input
					type="text" name="mid" id="email" class="form-control input-md"
					style="background-color: #677475;">
			</div>
			<div>
				<label for="password" style="color: white;">비밀번호</label> <br /> <input
					type="password" name="mpw" id="name" class="form-control input-md"
					style="background-color: #677475;">
